...
Definition DI_and_quant_rule H : Rule :=
  MkRULE
    [DI_box_seq H quantP1 quantP2,
     DI_box_seq H quantQ1 quantQ2]
    (DI_box_seq H (KFand quantP1 quantQ1) (KFand quantP2 quantQ2)).

Lemma DI_and_quant_rule_true : Rule_true (DI_and_quant_rule emHyps).
Proof.
           ...
           [
             ...
             step_K
               ...
               [USE_constant consta (KPodeSystem (ODEconst odec) quantH),
                ...
                USE_quant qsQ (KFand quantP1 quantQ1)],
             step_imply_left "w",
             step_K
               "w"
               [USE_constant consta (KPodeSystem (ODEconst odec) quantH),
                ...
                USE_quant qsQ (KFimply (KFquantifier qsP1 KFtrue)
                                       (KFand (KFquantifier qsP1 KFtrue) (KFquantifier qsQ1 KFtrue)))],
             step_imply_left "w",
             step_G
               "w"
               [USE_constant consta (KPodeSystem (ODEconst odec) quantH),
                USE_quant qsQ (KFimply (KFquantifier qsQ1 KFtrue)
                                       (KFimply (KFquantifier qsP1 KFtrue)
                                                (KFand (KFquantifier qsP1 KFtrue) (KFquantifier qsQ1 KFtrue))))],
             step_imply_right "x",
             step_imply_right "y",
             step_and_right,
