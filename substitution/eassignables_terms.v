...
Lemma eassignables_subset_divide1 :
  forall s t1 t2,
    eassignables_subset
      (free_vars_sub_restrict_term s t1)
      (free_vars_sub_restrict_term s (KTdivide t1 t2))
    = true.
Proof.
  introv.
  apply eassignables_subset_subterm; auto.
...
Lemma eassignables_subset_divide2 :
  forall s t1 t2,
    eassignables_subset
      (free_vars_sub_restrict_term s t2)
      (free_vars_sub_restrict_term s (KTdivide t1 t2))
...
Lemma eassignables_subset_power1 :
  forall s t1 t2,
    eassignables_subset
      (free_vars_sub_restrict_term s t1)
      (free_vars_sub_restrict_term s (KTpower t1 t2))
    = true.
Proof.
  introv.
  apply eassignables_subset_subterm; auto.
...
Lemma eassignables_subset_power2 :
  forall s t1 t2,
    eassignables_subset
      (free_vars_sub_restrict_term s t2)
      (free_vars_sub_restrict_term s (KTpower t1 t2))
