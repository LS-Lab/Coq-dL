...
Proof.
  unfold Deq, deceq; introv da db; introv; sp.
...
Theorem iff_push_down_forall : forall A (P Q: A-> Prop) ,
  (forall a, P a <o> Q a) -> ((forall a, P a) <o> (forall a, Q a)).
Proof. introv Hiff. repeat split; intros; apply Hiff; auto.
Qed.

Theorem iff_push_down_forallT : forall A (P Q: A-> Type) ,
  (forall a, P a <o> Q a) -> ((forall a, P a) <o> (forall a, Q a)).
Proof. introv Hiff. repeat split; intros; apply Hiff; auto.
Qed.
...
Theorem and_tiff_compat_l:
 forall A B C : Type, (B <o> C) -> (A ## B <o> A ## C).
Proof. 
